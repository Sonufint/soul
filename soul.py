...
TOKEN = '6822590463:AAG2Ns3XnC3SSf7MoLty7_IlG9P3zRwLGgY'
MONGO_URI = 'mongodb+srv://sonurdp:root@cluster0.ta3u2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
FORWARD_CHANNEL_ID = -1002190519046
CHANNEL_ID = -1002190519046
error_channel_id = -1002190519046
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/SONU_DDOS/117*", parse_mode='Markdown')
